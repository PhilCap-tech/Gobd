...
secondaryKeywords:
  ...
  - "Verfahrensdokumentation Finanzamt"
  - "GoBD Prüfung Verfahrensdokumentation"
ctaSoft: "/readiness"
ctaPrimary: "/checkout"
...
Mehr zum Aufbau: [GoBD Verfahrensdokumentation erstellen](/blog/gobd-verfahrensdokumentation-erstellen).

## Warum die Verfahrensdokumentation in der Prüfung relevant sein kann
...
Fehlt die Dokumentation, ist sie veraltet oder beschreibt etwas anderes als den Alltag, entstehen oft Rückfragen. Das heißt nicht automatisch „alles verloren“ — und eine vorhandene Datei heißt nicht automatisch „alles in Ordnung“. Es geht um **Nachvollziehbarkeit**, nicht um Show.

Besonders häufig wird die Doku relevant, wenn:

- Belege gescannt und Papieroriginale vernichtet werden ([ersetzendes Scannen](/blog/ersetzendes-scannen-verfahrensdokumentation))
- mehrere Systeme zusammenspielen (E-Mail, DMS, Buchhaltung, Cloud)
- Prozesse und Software seit der letzten Version gewechselt haben
- Zuständigkeiten unklar oder nur mündlich bekannt sind

## Was Prüfer typischerweise ansehen — ohne Garantie

Prüfungen sind unterschiedlich. Was folgt, ist **keine Checkliste der Finanzverwaltung**, sondern Praxisbeobachtungen, die viele Berater und Betriebe wiedererkennen:
...
Wie kommen Eingangs- und Ausgangsbelege rein? Wer prüft? Wo liegen Dateien? Wie kommt es zur Buchhaltung (inhouse oder Steuerberater)?
...
Wer pflegt die Verfahrensdokumentation? Wer hat sie freigegeben? Gibt es Version und Datum?

### 5. Beim Scannen: Qualität, Vernichtung, Ausnahmen

Scanprozess, Qualitätskontrolle, wann Originale vernichtet werden dürfen, welche Belege ausgenommen sind. Details: [Ersetzendes Scannen in der Verfahrensdokumentation](/blog/ersetzendes-scannen-verfahrensdokumentation).
...
Fehlen oder Unbrauchbarkeit kann zu Beanstandungen oder Mehrarbeit führen — vor allem bei unklaren digitalen Abläufen. Wie schwer das wiegt, ist einzelfallabhängig. Kein Artikel kann das Ergebnis vorhersagen.

### Was fragen Prüfer zur Verfahrensdokumentation am häufigsten?

Oft: Belegweg, Systeme, Verantwortliche, Aktualität und — falls relevant — Scan- und Vernichtungsprozess. Die Reihenfolge und Tiefe variieren.

### Reicht es, die Doku am Prüfungstag nachzureichen?

Manchmal wird nachgereicht — besser ist ein aktueller Stand *vorher*. Nachträgliches Schreiben unter Zeitdruck erhöht das Risiko von Lücken und Widersprüchen.

### Muss der Steuerberater die Dokumentation schreiben?
...
- [GoBD Verfahrensdokumentation erstellen](/blog/gobd-verfahrensdokumentation-erstellen) — Aufbau und Vorgehen
